...
<html class="   ">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>Puppet/modules/esb/4.8.0/esb/manifests/deploy.pp at master · wso2/Puppet · GitHub</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars0.githubusercontent.com/u/533043?s=400" property="og:image" /><meta content="wso2/Puppet" property="og:title" /><meta content="https://github.com/wso2/Puppet" property="og:url" /><meta content="Puppet manifests to deploy WSO2 servers" property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="0823C827:1FFD:3CEA39C:536883E7" name="octolytics-dimension-request_id" />
...
<meta content="JqkJFtnNjqXWfiDjBYedN8UBQHBxiWqJMM062qUAR8LznF40GiIJIczgsOb1ZLF/mMHWEY5B314zk5QVz4qBCw==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button signin" href="/login?return_to=%2Fwso2%2FPuppet%2Fblob%2Fmaster%2Fmodules%2Fesb%2F4.8.0%2Fesb%2Fmanifests%2Fdeploy.pp">Sign in</a>
    </div>
...
<a href="/wso2/Puppet/blob/8e07a466ef756521e1be3677d4a9f726df4764a5/modules/esb/4.8.0/esb/manifests/deploy.pp" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:ba3d1fe321e42f7ec93519a495821d99 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/wso2/Puppet/blob/master/modules/esb/4.8.0/esb/manifests/deploy.pp"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
    ...
    <div class="meta clearfix">
      ...
      <div class="actions">
        <div class="button-group">
          ...
          <a href="/wso2/Puppet/raw/master/modules/esb/4.8.0/esb/manifests/deploy.pp" class="button minibutton " id="raw-url">Raw</a>
            <a href="/wso2/Puppet/blame/master/modules/esb/4.8.0/esb/manifests/deploy.pp" class="button minibutton js-update-url-with-hash">Blame</a>
          <a href="/wso2/Puppet/commits/master/modules/esb/4.8.0/esb/manifests/deploy.pp" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<span id="L43" rel="#L43">43</span>
            ...
            <td class="blob-line-code"><div class="code-body highlight"><pre><div class='line' id='LC1'><span class="c"># ----------------------------------------------------------------------------</span></div><div class='line' id='LC2'><span class="c">#  Copyright 2005-2013 WSO2, Inc. http://www.wso2.org</span></div><div class='line' id='LC3'><span class="c">#</span></div><div class='line' id='LC4'><span class="c">#  Licensed under the Apache License, Version 2.0 (the &quot;License&quot;);</span></div><div class='line' id='LC5'><span class="c">#  you may not use this file except in compliance with the License.</span></div><div class='line' id='LC6'><span class="c">#  You may obtain a copy of the License at</span></div><div class='line' id='LC7'><span class="c">#</span></div><div class='line' id='LC8'><span class="c">#      http://www.apache.org/licenses/LICENSE-2.0</span></div><div class='line' id='LC9'><span class="c">#</span></div><div class='line' id='LC10'><span class="c">#  Unless required by applicable law or agreed to in writing, software</span></div><div class='line' id='LC11'><span class="c">#  distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></div><div class='line' id='LC12'><span class="c">#  WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></div><div class='line' id='LC13'><span class="c">#  See the License for the specific language governing permissions and</span></div><div class='line' id='LC14'><span class="c">#  limitations under the License.</span></div><div class='line' id='LC15'><span class="c"># ----------------------------------------------------------------------------</span></div><div class='line' id='LC16'><span class="c">#</span></div><div class='line' id='LC17'><span class="c"># Executes the deployment by pushing all necessary configurations and patches</span></div><div class='line' id='LC18'><br/></div><div class='line' id='LC19'><span class="k">define</span> <span class="na">esb</span><span class="p">::</span><span class="na">deploy</span> <span class="p">(</span><span class="nv">$security,</span> <span class="nv">$target,</span> <span class="nv">$owner,</span> <span class="nv">$group)</span> <span class="p">{</span></div><div class='line' id='LC20'>&nbsp;&nbsp;<span class="k">file</span> <span class="p">{</span> <span class="s">&quot;/tmp/${esb::deployment_code}&quot;</span><span class="p">:</span></div><div class='line' id='LC21'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="na">ensure</span>       <span class="o">=&gt;</span> <span class="k">present</span><span class="p">,</span></div><div class='line' id='LC22'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="na">owner</span>        <span class="o">=&gt;</span> <span class="nv">$owner,</span></div><div class='line' id='LC23'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="na">group</span>        <span class="o">=&gt;</span> <span class="nv">$group,</span></div><div class='line' id='LC24'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="na">sourceselect</span> <span class="o">=&gt;</span> <span class="na">all</span><span class="p">,</span></div><div class='line' id='LC25'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="na">ignore</span>       <span class="o">=&gt;</span> <span class="s">&#39;.svn&#39;</span><span class="p">,</span></div><div class='line' id='LC26'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="na">recurse</span>      <span class="o">=&gt;</span> <span class="k">true</span><span class="p">,</span></div><div class='line' id='LC27'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="na">source</span>       <span class="o">=&gt;</span> <span class="p">[</span></div><div class='line' id='LC28'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="s">&#39;puppet:///modules/esb/configs/&#39;</span><span class="p">,</span></div><div class='line' id='LC29'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="s">&#39;puppet:///modules/esb/patches/&#39;</span><span class="p">]</span></div><div class='line' id='LC30'>&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC31'><br/></div><div class='line' id='LC32'>&nbsp;&nbsp;<span class="k">exec</span> <span class="p">{</span></div><div class='line' id='LC33'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="s">&quot;Copy_${name}_modules_to_carbon_home&quot;</span><span class="p">:</span></div><div class='line' id='LC34'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="na">path</span>    <span class="o">=&gt;</span> <span class="s">&#39;/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/java/bin/&#39;</span><span class="p">,</span></div><div class='line' id='LC35'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="na">command</span> <span class="o">=&gt;</span> <span class="s">&quot;cp -r /tmp/${esb::deployment_code}/* ${target}/; chown -R ${owner}:${owner} ${target}/; chmod -R 755 ${target}/&quot;</span><span class="p">,</span></div><div class='line' id='LC36'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="na">require</span> <span class="o">=&gt;</span> <span class="k">File</span><span class="p">[</span><span class="s">&quot;/tmp/${esb::deployment_code}&quot;</span><span class="p">];</span></div><div class='line' id='LC37'><br/></div><div class='line' id='LC38'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="s">&quot;Remove_${name}_temporory_modules_directory&quot;</span><span class="p">:</span></div><div class='line' id='LC39'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="na">path</span>    <span class="o">=&gt;</span> <span class="s">&#39;/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/java/bin/&#39;</span><span class="p">,</span></div><div class='line' id='LC40'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="na">command</span> <span class="o">=&gt;</span> <span class="s">&quot;rm -rf /tmp/${esb::deployment_code}&quot;</span><span class="p">,</span></div><div class='line' id='LC41'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="na">require</span> <span class="o">=&gt;</span> <span class="k">Exec</span><span class="p">[</span><span class="s">&quot;Copy_${name}_modules_to_carbon_home&quot;</span><span class="p">];</span></div><div class='line' id='LC42'>&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC43'><span class="p">}</span></div></pre></div></td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.04832s from github-fe139-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
