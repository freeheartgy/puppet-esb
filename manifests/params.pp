...
<html class="   ">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>Puppet/modules/esb/4.8.0/esb/manifests/params.pp at master · wso2/Puppet · GitHub</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars0.githubusercontent.com/u/533043?s=400" property="og:image" /><meta content="wso2/Puppet" property="og:title" /><meta content="https://github.com/wso2/Puppet" property="og:url" /><meta content="Puppet manifests to deploy WSO2 servers" property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="0823C929:1FFC:233B6C2:536883F4" name="octolytics-dimension-request_id" />
...
<meta content="de8GfWMBjMM21L2gw7VS9HYl30uUzFtww5XbIyNzcGy5cMK0iC+5JsYOSHKE4Aos5bxvj8eteaJCFxvNu8GKtQ==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button signin" href="/login?return_to=%2Fwso2%2FPuppet%2Fblob%2Fmaster%2Fmodules%2Fesb%2F4.8.0%2Fesb%2Fmanifests%2Fparams.pp">Sign in</a>
    </div>
...
<a href="/wso2/Puppet/blob/8e07a466ef756521e1be3677d4a9f726df4764a5/modules/esb/4.8.0/esb/manifests/params.pp" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:9439333db885c310b7daacba442b32d4 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/wso2/Puppet/blob/master/modules/esb/4.8.0/esb/manifests/params.pp"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
    ...
    <div class="meta clearfix">
      ...
      <div class="actions">
        <div class="button-group">
          ...
          <a href="/wso2/Puppet/raw/master/modules/esb/4.8.0/esb/manifests/params.pp" class="button minibutton " id="raw-url">Raw</a>
            <a href="/wso2/Puppet/blame/master/modules/esb/4.8.0/esb/manifests/params.pp" class="button minibutton js-update-url-with-hash">Blame</a>
          <a href="/wso2/Puppet/commits/master/modules/esb/4.8.0/esb/manifests/params.pp" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<span id="L70" rel="#L70">70</span>
            ...
            <td class="blob-line-code"><div class="code-body highlight"><pre><div class='line' id='LC1'><span class="c-Singleline"># ----------------------------------------------------------------------------</span></div><div class='line' id='LC2'><span class="c-Singleline">#  Copyright 2005-2013 WSO2, Inc. http://www.wso2.org</span></div><div class='line' id='LC3'><span class="c-Singleline">#</span></div><div class='line' id='LC4'><span class="c-Singleline">#  Licensed under the Apache License, Version 2.0 (the &quot;License&quot;);</span></div><div class='line' id='LC5'><span class="c-Singleline">#  you may not use this file except in compliance with the License.</span></div><div class='line' id='LC6'><span class="c-Singleline">#  You may obtain a copy of the License at</span></div><div class='line' id='LC7'><span class="c-Singleline">#</span></div><div class='line' id='LC8'><span class="c-Singleline">#      http://www.apache.org/licenses/LICENSE-2.0</span></div><div class='line' id='LC9'><span class="c-Singleline">#</span></div><div class='line' id='LC10'><span class="c-Singleline">#  Unless required by applicable law or agreed to in writing, software</span></div><div class='line' id='LC11'><span class="c-Singleline">#  distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></div><div class='line' id='LC12'><span class="c-Singleline">#  WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></div><div class='line' id='LC13'><span class="c-Singleline">#  See the License for the specific language governing permissions and</span></div><div class='line' id='LC14'><span class="c-Singleline">#  limitations under the License.</span></div><div class='line' id='LC15'><span class="c-Singleline"># ----------------------------------------------------------------------------</span></div><div class='line' id='LC16'><span class="c-Singleline">#</span></div><div class='line' id='LC17'><span class="c-Singleline"># Class esb::params</span></div><div class='line' id='LC18'><span class="c-Singleline">#</span></div><div class='line' id='LC19'><span class="c-Singleline"># This class manages ESB parameters</span></div><div class='line' id='LC20'><span class="c-Singleline">#</span></div><div class='line' id='LC21'><span class="c-Singleline"># Parameters:</span></div><div class='line' id='LC22'><span class="c-Singleline">#</span></div><div class='line' id='LC23'><span class="c-Singleline"># Usage: Uncomment the variable and assign a value to override the wso2.pp value</span></div><div class='line' id='LC24'><span class="c-Singleline">#</span></div><div class='line' id='LC25'><span class="c-Singleline">#</span></div><div class='line' id='LC26'><br/></div><div class='line' id='LC27'><span class="kd">class</span> <span class="nc">esb::params</span> <span class="p">{</span></div><div class='line' id='LC28'>&nbsp;&nbsp;<span class="nv">$package_repo</span>         <span class="o">=</span> <span class="s1">&#39;http://downloads.wso2.com&#39;</span></div><div class='line' id='LC29'>&nbsp;&nbsp;<span class="nv">$depsync_svn_repo</span>     <span class="o">=</span> <span class="s1">&#39;https://svn.appfactory.domain.com/wso2/repo/&#39;</span></div><div class='line' id='LC30'>&nbsp;&nbsp;<span class="nv">$local_package_dir</span>    <span class="o">=</span> <span class="s1">&#39;/mnt/packs&#39;</span><span class="c-Singleline"></span></div><div class='line' id='LC31'><br/></div><div class='line' id='LC32'><span class="c-Singleline">  # Service subdomains</span></div><div class='line' id='LC33'>&nbsp;&nbsp;<span class="nv">$domain</span>               <span class="o">=</span> <span class="s1">&#39;wso2.com&#39;</span></div><div class='line' id='LC34'>&nbsp;&nbsp;<span class="nv">$esb_subdomain</span>        <span class="o">=</span> <span class="s1">&#39;esb&#39;</span></div><div class='line' id='LC35'>&nbsp;&nbsp;<span class="nv">$management_subdomain</span> <span class="o">=</span> <span class="s1">&#39;management&#39;</span></div><div class='line' id='LC36'><br/></div><div class='line' id='LC37'>&nbsp;&nbsp;<span class="nv">$admin_username</span>       <span class="o">=</span> <span class="s1">&#39;admin&#39;</span></div><div class='line' id='LC38'>&nbsp;&nbsp;<span class="nv">$admin_password</span>       <span class="o">=</span> <span class="s1">&#39;admin123&#39;</span><span class="c-Singleline"></span></div><div class='line' id='LC39'><br/></div><div class='line' id='LC40'><span class="c-Singleline">  # MySQL server configuration details</span></div><div class='line' id='LC41'>&nbsp;&nbsp;<span class="nv">$mysql_server</span>         <span class="o">=</span> <span class="s1">&#39;mysql.wso2.com&#39;</span></div><div class='line' id='LC42'>&nbsp;&nbsp;<span class="nv">$mysql_port</span>           <span class="o">=</span> <span class="s1">&#39;3306&#39;</span></div><div class='line' id='LC43'>&nbsp;&nbsp;<span class="nv">$max_connections</span>      <span class="o">=</span> <span class="s1">&#39;100000&#39;</span></div><div class='line' id='LC44'>&nbsp;&nbsp;<span class="nv">$max_active</span>           <span class="o">=</span> <span class="s1">&#39;150&#39;</span></div><div class='line' id='LC45'>&nbsp;&nbsp;<span class="nv">$max_wait</span>             <span class="o">=</span> <span class="s1">&#39;360000&#39;</span><span class="c-Singleline"></span></div><div class='line' id='LC46'><br/></div><div class='line' id='LC47'><span class="c-Singleline">  # Database details</span></div><div class='line' id='LC48'>&nbsp;&nbsp;<span class="nv">$registry_user</span>        <span class="o">=</span> <span class="s1">&#39;registry&#39;</span></div><div class='line' id='LC49'>&nbsp;&nbsp;<span class="nv">$registry_password</span>    <span class="o">=</span> <span class="s1">&#39;ycJaCboyUo&#39;</span></div><div class='line' id='LC50'>&nbsp;&nbsp;<span class="nv">$registry_database</span>    <span class="o">=</span> <span class="s1">&#39;governance&#39;</span></div><div class='line' id='LC51'><br/></div><div class='line' id='LC52'>&nbsp;&nbsp;<span class="nv">$userstore_user</span>       <span class="o">=</span> <span class="s1">&#39;userstore&#39;</span></div><div class='line' id='LC53'>&nbsp;&nbsp;<span class="nv">$userstore_password</span>   <span class="o">=</span> <span class="s1">&#39;sUAKn09o5J&#39;</span></div><div class='line' id='LC54'>&nbsp;&nbsp;<span class="nv">$userstore_database</span>   <span class="o">=</span> <span class="s1">&#39;userstore&#39;</span><span class="c-Singleline"></span></div><div class='line' id='LC55'><br/></div><div class='line' id='LC56'><span class="c-Singleline">  # Depsync settings</span></div><div class='line' id='LC57'>&nbsp;&nbsp;<span class="nv">$svn_user</span>             <span class="o">=</span> <span class="s1">&#39;wso2&#39;</span></div><div class='line' id='LC58'>&nbsp;&nbsp;<span class="nv">$svn_password</span>         <span class="o">=</span> <span class="s1">&#39;wso2123&#39;</span><span class="c-Singleline"></span></div><div class='line' id='LC59'><br/></div><div class='line' id='LC60'><span class="c-Singleline">  # Auto-scaler</span></div><div class='line' id='LC61'>&nbsp;&nbsp;<span class="nv">$auto_scaler_epr</span>      <span class="o">=</span> <span class="s1">&#39;http://xxx:9863/services/AutoscalerService/&#39;</span><span class="c-Singleline"></span></div><div class='line' id='LC62'><br/></div><div class='line' id='LC63'><span class="c-Singleline">  #LDAP settings </span></div><div class='line' id='LC64'>&nbsp;&nbsp;<span class="nv">$ldap_connection_uri</span>      <span class="o">=</span> <span class="s1">&#39;ldap://localhost:10389&#39;</span></div><div class='line' id='LC65'>&nbsp;&nbsp;<span class="nv">$bind_dn</span>                  <span class="o">=</span> <span class="s1">&#39;uid=admin,ou=system&#39;</span></div><div class='line' id='LC66'>&nbsp;&nbsp;<span class="nv">$bind_dn_password</span>         <span class="o">=</span> <span class="s1">&#39;adminpassword&#39;</span></div><div class='line' id='LC67'>&nbsp;&nbsp;<span class="nv">$user_search_base</span>         <span class="o">=</span> <span class="s1">&#39;ou=system&#39;</span></div><div class='line' id='LC68'>&nbsp;&nbsp;<span class="nv">$group_search_base</span>        <span class="o">=</span> <span class="s1">&#39;ou=system&#39;</span></div><div class='line' id='LC69'>&nbsp;&nbsp;<span class="nv">$sharedgroup_search_base</span>  <span class="o">=</span> <span class="s1">&#39;ou=SharedGroups,dc=wso2,dc=org&#39;</span></div><div class='line' id='LC70'>}</div></pre></div></td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.04643s from github-fe122-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
