...
<html class="   ">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>Puppet/modules/esb/4.8.0/esb/manifests/clean.pp at master · wso2/Puppet · GitHub</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars0.githubusercontent.com/u/533043?s=400" property="og:image" /><meta content="wso2/Puppet" property="og:title" /><meta content="https://github.com/wso2/Puppet" property="og:url" /><meta content="Puppet manifests to deploy WSO2 servers" property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="0823C928:2000:188EB97:536883DF" name="octolytics-dimension-request_id" />
...
<meta content="auvRuyU6pM0mEuE+aig0j3Ru98Cx/w5LRRf8lLWE3gVtJZGlcWSMYTbgPuui/HWCG13n+pJrNgpXUfpEHqQk7w==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button signin" href="/login?return_to=%2Fwso2%2FPuppet%2Fblob%2Fmaster%2Fmodules%2Fesb%2F4.8.0%2Fesb%2Fmanifests%2Fclean.pp">Sign in</a>
    </div>
...
<a href="/wso2/Puppet/blob/8e07a466ef756521e1be3677d4a9f726df4764a5/modules/esb/4.8.0/esb/manifests/clean.pp" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:f448b1023ad11e8232264ab54d3f3332 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/wso2/Puppet/blob/master/modules/esb/4.8.0/esb/manifests/clean.pp"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
    ...
    <div class="meta clearfix">
      ...
      <div class="actions">
        <div class="button-group">
          ...
          <a href="/wso2/Puppet/raw/master/modules/esb/4.8.0/esb/manifests/clean.pp" class="button minibutton " id="raw-url">Raw</a>
            <a href="/wso2/Puppet/blame/master/modules/esb/4.8.0/esb/manifests/clean.pp" class="button minibutton js-update-url-with-hash">Blame</a>
          <a href="/wso2/Puppet/commits/master/modules/esb/4.8.0/esb/manifests/clean.pp" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<span id="L45" rel="#L45">45</span>
            ...
            <td class="blob-line-code"><div class="code-body highlight"><pre><div class='line' id='LC1'><span class="c-Singleline"># ----------------------------------------------------------------------------</span></div><div class='line' id='LC2'><span class="c-Singleline">#  Copyright 2005-2013 WSO2, Inc. http://www.wso2.org</span></div><div class='line' id='LC3'><span class="c-Singleline">#</span></div><div class='line' id='LC4'><span class="c-Singleline">#  Licensed under the Apache License, Version 2.0 (the &quot;License&quot;);</span></div><div class='line' id='LC5'><span class="c-Singleline">#  you may not use this file except in compliance with the License.</span></div><div class='line' id='LC6'><span class="c-Singleline">#  You may obtain a copy of the License at</span></div><div class='line' id='LC7'><span class="c-Singleline">#</span></div><div class='line' id='LC8'><span class="c-Singleline">#      http://www.apache.org/licenses/LICENSE-2.0</span></div><div class='line' id='LC9'><span class="c-Singleline">#</span></div><div class='line' id='LC10'><span class="c-Singleline">#  Unless required by applicable law or agreed to in writing, software</span></div><div class='line' id='LC11'><span class="c-Singleline">#  distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></div><div class='line' id='LC12'><span class="c-Singleline">#  WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></div><div class='line' id='LC13'><span class="c-Singleline">#  See the License for the specific language governing permissions and</span></div><div class='line' id='LC14'><span class="c-Singleline">#  limitations under the License.</span></div><div class='line' id='LC15'><span class="c-Singleline"># ----------------------------------------------------------------------------</span></div><div class='line' id='LC16'><span class="c-Singleline">#</span></div><div class='line' id='LC17'><span class="c-Singleline"># Cleans the previous deployment. If the maintenance mode is set to true, this will only kill the running service.</span></div><div class='line' id='LC18'><br/></div><div class='line' id='LC19'><span class="kd">define</span> <span class="nc">esb::clean</span> <span class="p">(</span><span class="nv">$mode</span><span class="p">,</span> <span class="nv">$target</span><span class="p">)</span> <span class="p">{</span></div><div class='line' id='LC20'>&nbsp;&nbsp;<span class="kr">if</span> <span class="nv">$mode</span> <span class="o">==</span> <span class="s1">&#39;refresh&#39;</span> <span class="p">{</span></div><div class='line' id='LC21'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="nc">exec</span><span class="p">{</span></div><div class='line' id='LC22'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="s2">&quot;Remove_lock_file_</span><span class="si">${name}</span><span class="s2">&quot;</span><span class="p">:</span></div><div class='line' id='LC23'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="nt">path</span>    <span class="p">=&gt;</span> <span class="s1">&#39;/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin&#39;</span><span class="p">,</span></div><div class='line' id='LC24'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="nt">onlyif</span>  <span class="p">=&gt;</span> <span class="s2">&quot;test -f </span><span class="si">${target}</span><span class="s2">/wso2carbon.lck&quot;</span><span class="p">,</span></div><div class='line' id='LC25'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="nt">command</span> <span class="p">=&gt;</span> <span class="s2">&quot;rm </span><span class="si">${target}</span><span class="s2">/wso2carbon.lck&quot;</span><span class="p">;</span></div><div class='line' id='LC26'><br/></div><div class='line' id='LC27'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="s2">&quot;Stop_process_</span><span class="si">${name}</span><span class="s2">&quot;</span><span class="p">:</span></div><div class='line' id='LC28'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="nt">path</span>    <span class="p">=&gt;</span> <span class="s1">&#39;/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/java/bin/&#39;</span><span class="p">,</span></div><div class='line' id='LC29'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="nt">command</span> <span class="p">=&gt;</span> <span class="s2">&quot;kill -9 `cat </span><span class="si">${target}</span><span class="s2">/wso2carbon.pid` ; /bin/echo Killed&quot;</span><span class="p">,</span></div><div class='line' id='LC30'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="nt">require</span> <span class="p">=&gt;</span> <span class="nc">Exec</span><span class="p">[</span><span class="s2">&quot;Remove_lock_file_</span><span class="si">${name}</span><span class="s2">&quot;</span><span class="p">];</span></div><div class='line' id='LC31'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC32'>&nbsp;&nbsp;}</div><div class='line' id='LC33'>&nbsp;&nbsp;<span class="kr">elsif</span> <span class="nv">$mode</span> <span class="o">==</span> <span class="s1">&#39;new&#39;</span> <span class="p">{</span></div><div class='line' id='LC34'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="nc">exec</span> <span class="p">{</span> <span class="s2">&quot;Stop_process_and_remove_CARBON_HOME_</span><span class="si">${name}</span><span class="s2">&quot;</span><span class="p">:</span></div><div class='line' id='LC35'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="nt">path</span>    <span class="p">=&gt;</span> <span class="s1">&#39;/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/java/bin/&#39;</span><span class="p">,</span></div><div class='line' id='LC36'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="nt">command</span> <span class="p">=&gt;</span> <span class="s2">&quot;kill -9 `cat </span><span class="si">${target}</span><span class="s2">/wso2carbon.pid` ; rm -rf </span><span class="si">${target}</span><span class="s2">&quot;</span><span class="p">;</span></div><div class='line' id='LC37'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC38'>&nbsp;&nbsp;}</div><div class='line' id='LC39'>&nbsp;&nbsp;<span class="kr">elsif</span> <span class="nv">$mode</span> <span class="o">==</span> <span class="s1">&#39;zero&#39;</span> <span class="p">{</span></div><div class='line' id='LC40'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="nc">exec</span> <span class="p">{</span> <span class="s2">&quot;Stop_process_remove_CARBON_HOME_and_pack_</span><span class="si">${name}</span><span class="s2">&quot;</span><span class="p">:</span></div><div class='line' id='LC41'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="nt">path</span>    <span class="p">=&gt;</span> <span class="s1">&#39;/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/java/bin/&#39;</span><span class="p">,</span></div><div class='line' id='LC42'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="nt">command</span> <span class="p">=&gt;</span> <span class="s2">&quot;kill -9 `cat </span><span class="si">${target}</span><span class="s2">/wso2carbon.pid` ; rm -rf </span><span class="si">${target}</span><span class="s2"> ; rm -f </span><span class="si">${::local_package_dir}</span><span class="s2">/wso2</span><span class="si">${esb::service_code}</span><span class="s2">-</span><span class="si">${esb::version}</span><span class="s2">.zip&quot;</span><span class="p">;</span></div><div class='line' id='LC43'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC44'>&nbsp;&nbsp;}</div><div class='line' id='LC45'>}</div></pre></div></td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.05501s from github-fe138-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
